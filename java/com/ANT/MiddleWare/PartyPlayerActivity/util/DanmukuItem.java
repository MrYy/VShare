...
public class DanmukuItem implements IDanmukuItem {
...
//        strokePaint.setTypeface(Typeface.DEFAULT_BOLD);
     ...
     */
    public DanmukuItem(Context context, CharSequence content, int startX) {
        this(context, new SpannableString(content), startX, 0, 0, 0, 1f);
    }

    public DanmukuItem(Context context, CharSequence content, int startX, int startY) {
        this(context, new SpannableString(content), startX, startY, 0, 0, 1f);
    }


    public DanmukuItem(Context context, SpannableString content, int startX, int startY,
...
//        }
     ...
     * @return hit or not
     */
    public boolean willHit(IDanmukuItem runningItem) {
        ...
        float t1 = len1 / (runningItem.getSpeedFactor() * DanmukuItem.sBaseSpeed);
        float len2 = t1 * mFactor * DanmukuItem.sBaseSpeed;
        if (len2 > len1) {
            return true;
        } else {
            return false;
    ...
    public static void setBaseSpeed(int baseSpeed) {
        DanmukuItem.sBaseSpeed = baseSpeed;
    }
